...
def enemy_image_path(enemy_type_number : int):
    ...
    image_folder = Path("main/assets/enemy_images")
...
def tower_image_path_list(tower_type_number : int):
    ...
    image_folder = Path("main/assets/tower_images")
